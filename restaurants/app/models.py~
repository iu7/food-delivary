...
class Orders(db.Model):
	...
	def __repr__(self):
		return '<Orders: id: %s, restaurant_id: %s, date: %s, confirmed: %s, online_payment: %s' \
			% (str(self.id), str(self.restaurant_id),\
				self.date.strftime(RestaurantConfig.DTIME_FORMAT), str(self.confirmed), str(self.online_payment))
